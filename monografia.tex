...
\begin{titlepage}
 ...
 \begin{center}
  ...
  {\Large \textsc{Departamento de Ciência da Computação} } \\ [1.5ex] 

  {\Huge Plataforma Unificada de Apoio ao Ensino (pensar em um título melhor)} \vfill
  {\Large Autores: Igor Barbosa Pinto \& Tiago Cândido Almeida Santos} \\ [1.5ex]
  {\Large Orientador: Prof. Raphael Pereira de Oliveira Guerra} \\ [3ex]
